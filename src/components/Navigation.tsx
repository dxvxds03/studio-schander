...
export default function Navigation({ background = 'var(--cream)' }: { background?: string }) {
  const isOrange = background !== 'var(--cream)'
        ...
        <div className="nav-ctas">
          <Link
            ...
            style={{
              ...
              ...(isOrange && { color: 'var(--ink)', borderColor: 'var(--ink)' }),
            }}
          >
          ...
          <Link
            href="/kontakt"
            data-hover
            className="nav-btn nav-btn-kontakt"
